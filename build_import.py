...
books = [
    ("The Art of Unfinished Things", "Laila Morningside", "14.99", [
    ...
    ("Why We Forget", "Dr. Elias Rowan", "19.50", [
    ...
    ("The Invisible Rules of Conversation", "Mira Chen", "12.00", [
    ...
    ("How to Travel Without Moving", "Jonah Vale", "16.75", [
    ...
    ("The Mathematics of Happiness", "Sofia Delgado", "21.00", [
    ...
    ("Echoes of Tomorrow", "Daniel Stryker", "18.99", [
    ...
    ("The Cartographer of Dreams", "Julian Northwood", "22.50", [
    ...
    ("The Physics of Loneliness", "Daniel Kessler", "17.25", [
    ...
    ("The Library of Lost Sounds", "Alec Hartman", "15.80", [
    ...
    ("The Algorithm of Emotion", "Daniel Kepler", "20.00", [
...
result = []
for name, author, price, takeaways in books:
    result.append({
        "name": name,
        "author": author,
        "price": price,
